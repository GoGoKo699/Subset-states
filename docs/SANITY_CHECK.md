...
| No TeX sources were present, but documentation contained TeX notation and the repository retained 14 PDF figures | Converted prose mathematics to plain text/Unicode, removed PDF duplicates, and made plot defaults PNG without an external TeX dependency |
