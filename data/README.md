...
These inherited CSV files are preserved as evidence. Regeneration defaults write under `generated/`; they do not replace these files.
...
| [residue_matched_samples.csv](residue_matched_samples.csv) | 12,000 paired entropy observations; no raw support labels |
| [residue_entropy_bounds.csv](residue_entropy_bounds.csv) | Residue populations and exact computational-basis entropy ceilings |

See [provenance](../PROVENANCE.md) for limitations and [research notes](../docs/RESEARCH.md) for definitions.
