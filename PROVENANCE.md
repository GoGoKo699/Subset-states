...
\((\widehat M_n,\widehat S_n)\) for even \(n=10,\ldots,30\).
...
local window around a recorded \(\widehat M_n\) and fits a quadratic in
...
\[
\widehat S_n=0.509300\,n-0.990091,
\]

\[
\log_2\widehat M_n=0.703541\,n-0.357734.
\]
...
\[
\widehat S_n=0.514457\,n-1.065190,
\]

\[
\log_2\widehat M_n=0.693450\,n-0.210116.
\]
